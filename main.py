...
def cadastrarHospede():
    ...
    categoria = input("Categoria desejada ->> (simples, duplo, casal e luxo): ")
    num_quarto = int(input("Número do Quarto: "))
    data_reserva = input("Data de Entrada: ")
    data_desocupa = input("Data de Saída: ")
    print('Deseja a Mais algum Quarto?  1 para sim - 0 para sair: ')
